    ...
    return(
        ...
        <div className="h-left">
            <div className="h-name">
                ...
                <span className="Span1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum, 
                      mollitia laboriosam eum quaerat voluptas dolorem molestias dignissimos </span>
            </div>
            <button className="h-button" style={{fontFamily: 'Courier New, Courier, monospace', textTransform: 'uppercase'}}>
    To Rent
</button>
